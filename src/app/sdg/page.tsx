                ...
                <div className="container mx-auto px-4 bg-white md:py-20 py-16 rounded-[50px] md:rounded-[100px]">
                    <div className="max-w-[920px] mx-auto">
                        ...
                        <p className="text-lg font-normal text-primary mt-4">
                            According to the World Health Organization, more than 2 billion people use a drinking water source contaminated with feces, and more than 800,000 people die each year from diarrheal diseases linked to unsafe water and sanitation.
                        </p>
                        <p className="text-lg font-normal text-primary mt-4">
                        ...
                        <ul>
                            <li className="text-lg font-normal text-primary mt-2">
